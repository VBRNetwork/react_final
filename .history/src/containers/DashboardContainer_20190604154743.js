...
import { Menu, Icon, Button, Avatar, Progress, Row, Card, Switch, Layout, List, Col } from 'antd';
...
class  DashboardContainer extends Component {
  ...
  render () {
    return (
      ...
      <div>
          <div>
              <Avatar style={{ backgroundColor: '#87d068', float: 'right', marginRight: '15px', marginTop: '5px' }} icon="user" />
          </div>
