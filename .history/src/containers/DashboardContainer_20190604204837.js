  ...
  render () {
    ...
    <div>
           <Row>
            ...
            <Avatar style={{ backgroundColor: '#87d068', marginRight: '15px', marginTop: '10px' }} icon="user" />
...
<div>
            ...
            <Row>
                <Col span={7}>
                    <Card size="small" title="Wallet Preview" extra={<a href="#">More</a>} style={{ padding: 10 }}>
                ...
                <Col span={17}>
                    <Card size="small" title="Small size card" extra={<a href="#">More</a>}  style={{ padding: 10 }} >
                        <Col span={12}>
                            <Card>
                            <Statistic
                                title="Active"
