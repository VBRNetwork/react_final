            ...
            <Card size="small">
                <Row>
                    <div style={{position: 'absolute'}}>
                        <img style={{width: '101%', marginLeft: '-5px'}} alt="dashboardImg" src='../../static/images/dash3.jpg'/>
                    </div>
                    <br />
                    <Col span={8} >
                        <div>
                            <a href="#"><h2 style={{color: '#FFF'}}>Dashboard</h2></a>
                        </div>
                    </Col>
                    <Col  span={8} offset={8}>
                        <Avatar size="large" icon="user" style={{ float:'right', backgroundColor: '#2ec3ab' , cursor:'pointer'}} /> 
                    </Col>
                    <Col  span={6} offset={18}>
                        <Dropdown overlay={menu} >
                            <a  style={{ float:'right', color: '#FFF' }} className="ant-dropdown-link" href="#">
                                        ...
                                        <Col span={24}>
                                            ...
                                            <Card title="Stats" >
                                                <Row gutter={16}>
                                                    <Col span={24}>
                                                        <Col span={6} offset={6}>
                                                            <Statistic title="Reviews" value={1128} prefix={<Icon type="like" />} />
                                                        </Col>
                                                        <Col span={6} offset={6}>
                                                            <Statistic title="Completed Jobs" value={93} suffix="/ 100" />
                                                        </Col>
                                                    </Col>
                                                </Row>
                                            </Card > 
