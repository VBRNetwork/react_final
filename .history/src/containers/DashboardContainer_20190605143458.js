...
import { Menu, Icon, Button, Avatar, Progress, Row, Card, Switch, Layout, List, Col, Statistic,Timeline } from 'antd';
            ...
            <Layout style={{ background: '#fff' }}>
                ...
                <Content>
                    ...
                    <div style={{padding:'5px'}}>
                        <Row gutter={15}>
                            <Col span={7}>
                                <Card size="small" title="Your profile" extra={<a href="#">More</a>} >
                                    <div><Avatar size={64} icon="user" /> <strong>Stefan Vanea</strong></div>
                                </Card>
                            </Col>
                            <Col span={17}>
