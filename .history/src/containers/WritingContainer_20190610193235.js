...
const data = [
  <a style={{marginLeft: '2%' , color: '#37405E'}} href= "#">Content Writing</a>,
  <a style={{marginLeft: '2%' , color: '#37405E'}} href= "#">Content Translation</a>,
  <a style={{marginLeft: '2%' , color: '#37405E'}} href= "#">Business, Technical, or Legal Translation</a>,
  <a style={{marginLeft: '2%' , color: '#37405E'}} href= "#">Blog Posts</a>,
  <a style={{marginLeft: '2%' , color: '#37405E'}} href= "#">WebSite Content</a>,
];
