            ...
            <Card size="small">
                <Row>
                   <Col span={24}> 
                    ...
                    <Col span={8} >
                        <div>
                            <a href="#"><h2 style={{color: '#FFF', marginLeft: '2%'}}>Dashboard</h2></a>
                        </div>
                    </Col>
                    <Col  span={8} offset={8}>
                        <Avatar size="large" icon="user" style={{ float:'right', backgroundColor: '#2ec3ab' , cursor:'pointer', marginRight: '2%'}} /> 
                    </Col>
                    <Col  span={6} offset={18}>
                        <Dropdown overlay={menu} >
                            <a  style={{ float:'right', color: '#FFF',  marginRight: '2%' }} className="ant-dropdown-link" href="#">
