...
const categories= [
        {name:'Writing',icon:'writing-document',url:'/writing'}, 
        {name:'Marketing & SEO',icon:'like',url:'/writing'},
        {name:'Design',icon:'laptop',url:'/writing'},
        {name:'Business Consultancy',icon:'',url:'/writing'}, 
        {name:'Developers',icon:'code',url:'/writing'},
