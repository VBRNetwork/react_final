    ...
    return (
        <div>
            ...
            <Menu  selectedKeys={[this.state.current]} mode="horizontal" style={{boxShadow: '1px 4px 12px 1px #929292'}}>
                    ...
                    <Menu.Item key="mail2">
                        <Link href="/writing">
                            <a>  <Icon style={{fontSize: 15}} type="file-text" /> Writing</a>
                        </Link>
                    </Menu.Item>
                    ...
                    <Menu.Item key="app2" >
                        <Link href="/marketing-seo">
                            <a>  <Icon style={{fontSize: 15}} type="like" /> Marketing & SEO</a>
                        </Link>
                    </Menu.Item>
                    <Menu.Item key="alipay42">
                        <Link href="/design">
                            <a>  <Icon  style={{fontSize: 15}} type="laptop" /> Design</a>
                        </Link>
                    </Menu.Item>
                    <Menu.Item key="alipay36">
                        <Link href="/consultance">
                            <a>  <Icon style={{fontSize: 15}} type="pie-chart" /> Business Consultancy</a>
                        </Link>
                    </Menu.Item>
                    <Menu.Item key="alipay59">
                        <Link href="/developers">
                            <a>  <Icon style={{fontSize: 15}} type="code" /> Developers</a>
                        </Link>
                    </Menu.Item>
                    <SubMenu
                        title={
