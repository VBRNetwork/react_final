    ...
    return (
        <div>
            ...
            <Menu  selectedKeys={[this.state.current]} mode="horizontal" style={{boxShadow: '1px 4px 12px 1px #929292'}}>
                    ...
                    <Menu.Item key="mail2">
                        <Link href="/writing">
                            <a>  <Icon type="file-text" /> Writing & Translation</a>
                        </Link>
                    </Menu.Item>
                    ...
                    <Menu.Item key="app2" >
                        <Link href="/marketing-seo">
                            <a>  <Icon type="like" /> Marketing & SEO</a>
                        </Link>
                    </Menu.Item>
                    <Menu.Item key="alipay42">
                        <Link href="/design">
                            <a>  <Icon type="laptop" /> Web & Graphic Design</a>
                        </Link>
                    </Menu.Item>
                    <Menu.Item key="alipay36">
                        <Link href="/consultance">
                            <a>  <Icon type="mail" /> Business Consultancy</a>
                        </Link>
                    </Menu.Item>
                    <Menu.Item key="alipay59">
                        <Link href="/developers">
                            <a>  <Icon type="code" /> Developers & Coding</a>
                        </Link>
                    </Menu.Item>
                    <SubMenu
                        title={
